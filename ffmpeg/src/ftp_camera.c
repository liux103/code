...
static int encode_write_frame(AVFrame *sws_frame, unsigned int stream_index) 
{
    int ret;
    int got_frame;
    AVPacket enc_pkt;
...
static int swscale_encode_write_frame(AVFrame *frame, int stream_index)
{
	int ret = 0;
...
int main(int argc, char **argv)
{
    ...
    open_input_file("video=HP Webcam-101");
	
	open_output_file("rtmp://169.254.96.183:1935/live/home");
